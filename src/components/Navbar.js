          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" onClick={navbar_toggler_close} to="/">
                  Home
                </Link>
              </li>
              ...
              <li className="nav-item">
                <Link className="nav-link" onClick={navbar_toggler_close} to="/">
                  ABOUT US
                </Link>
              </li>
            </ul>
